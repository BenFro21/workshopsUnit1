public class Weather {
    ...
    public static double fahrenheitToCelsius(double fahrenheit){
        double celsiustemperature = (fahrenheit - 32) * 5 / 9;
    ...
    public static void printTemperatures(double fahrenheit){
        System.out.println("The tempature in Farinheight is: " + fahrenheit);
        System.out.println("The tempature in celsius is " + fahrenheitToCelsius(fahrenheit));
    }
}